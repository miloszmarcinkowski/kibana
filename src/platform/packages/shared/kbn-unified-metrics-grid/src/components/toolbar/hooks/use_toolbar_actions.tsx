...
export const useToolbarActions = ({
  ...
  const { dimensions, onDimensionsChange, isFullscreen, onToggleFullscreen } =
  ...
  const leftSideActions = useMemo(
    ...
    [isSmallScreen, dimensions, fields, onDimensionsChange, hideDimensionsSelector, isLoading]
  );
